...
// setModelRateLimitByModelName 根据模型名解析 Antigravity scope 并设置限流。
// 仅支持 claude/gemini_text/gemini_image 三类 scope。
// 返回是否已成功设置（若模型名为空、无法解析为 scope 或 repo 为 nil 将返回 false）。

...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/codex-tickets/overview", h.Admin.Setting.GetCodexTicketOverview)
		adminSettings.GET("/codex-tickets/logs", h.Admin.Setting.GetCodexTicketLogs)
